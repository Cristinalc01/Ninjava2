...
public class BaseTest {
    ...
    public void initializeDriver(String browser){
        switch (browser){
            case "chrome":
                System.setProperty("webdriver.chrome.driver", "/Users/cristinal/Desktop/Selenium/libs/chromedriver");
                driver = new ChromeDriver();
                break;
            case "firefox":
                System.setProperty("webdriver.gecko.driver", "/Users/cristinalc/Desktop/Selenium/libs/chromedriver");
